...
const DEFAULT_LOKUS = process.env.DEFAULT_LOKUS || null;
const FILTER_BY_REGION = process.env.FILTER_BY_REGION === 'true';
...
export {
  ...
  DEFAULT_LOKUS,      // Tambahkan ini
  FILTER_BY_REGION,   // Tambahkan ini
};
