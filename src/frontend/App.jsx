...
const logoSmi = new URL('./assets/foto/smi-removebg-preview.png', import.meta.url).href;
...
export function App() {
  useEffect(() => {
    ...
    // Ganti baris 9 dan 10 jadi begini:
  ...
  return (
    <div id="preact-wrapper">
      <div class="hdr">
        <div class="hdr-l">
          <div class="logo">
            <img src={logoSmi} alt="Logo SMi" />
          </div>
          <div class="hdr-t">
            <h1>Anggaran Kota Sukabumi</h1>
